...
while (1 -eq 1)
{
    ...
    foreach ($tenantShard in $tenantShardLocations)
    {
        ...
        {
            $serverResourceGroup = (Get-AzureRmResource -ResourceNameEquals $tenantServerName -ResourceType "Microsoft.Sql/servers").ResourceGroupName
    ...
    foreach ($resource in $tenantResources)
    {
        ...
        $databaseResourceGroup = (Get-AzureRmResource -ResourceNameEquals $databaseName -ResourceType "Microsoft.Sql/servers/databases").ResourceGroupName
