...
$ResourceGroupName = "wingtip-dpt-js1" # the resource group used when the Wingtip SaaS application was deployed. CASE SENSITIVE
$User              = "js1"         # the User value entered when the Wingtip SaaS application was deployed
